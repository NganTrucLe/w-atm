...
const DUMMY_BANKS = [
  Bank(name: 'ACB Bank', avatarLink: 'assets/images/ACB.png'),
  Bank(name: 'Bac A Bank', avatarLink: 'assets/images/Bac A Bank.png'),
  Bank(name: 'BIDV Bank', avatarLink: 'assets/images/BIDV.png'),
  Bank(name: 'HDBank', avatarLink: 'assets/images/HDBank.png'),
  Bank(name: 'KienlongBank', avatarLink: 'assets/images/KienLongBank.png'),
  Bank(name: 'Sacombank', avatarLink: 'assets/images/sacom new.png'),
  Bank(name: 'MB Bank', avatarLink: 'assets/images/MB Bank.png'),
  Bank(name: 'OCB Bank', avatarLink: 'assets/images/OCB.png'),
  Bank(name: 'PVcombank', avatarLink: 'assets/images/PVcombank.jpg'),
  Bank(name: 'SeABank', avatarLink: 'assets/images/SeABank.png'),
  Bank(
